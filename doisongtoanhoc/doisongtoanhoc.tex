...
\vskip 0.1cm
Hình minh họa sau đây sử dụng $15$ nước đi. Còn bạn thì sao?
\begin{center}
		\begin{tikzpicture}[doisongtoanhoc,scale=0.6]
				\draw (0,0) grid (9,9);
				\draw  (4.5,.5) node {$9$};
				\draw  (1.5,1.5) node {$7$};
				\draw  (7.5,1.5) node {$11$};
				\draw  (3.5,2.5) node {$8$};
				\draw  (5.5,2.5) node {$10$};
				\draw  (2.5,3.5) node {$6$};
				\draw  (6.5,3.5) node {$12$};
				\draw  (0.5,4.5) node {$5$};
				\draw  (4.5,4.5) node {$15$};
				\draw  (8.5,4.5) node {$13$};
				\draw  (2.5,5.5) node {$4$};
				\draw  (6.5,5.5) node {$14$};
				\draw  (3.5,6.5) node {$2$};
				\draw  (5.5,6.5) node {$0$};
				\draw  (1.5,7.5) node {$3$};
				\draw  (4.5,8.5) node {$1$};
