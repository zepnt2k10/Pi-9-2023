...
%\blfootnote{\color{quantoan}\color{quantoan}$^1$/}
\begingroup
\AddToShipoutPicture*{\put(0,616){\includegraphics[width=19.3cm]{../bannerquantoan}}}
\AddToShipoutPicture*{\put(90,525){\includegraphics[scale=1]{../tieude.pdf}}}
\centering
\endgroup
\vspace*{180pt}
...
\begin{multicols}{2}
	...
	\begin{figure}[H]
		...
		\centering
		\captionsetup{labelformat= empty, justification=centering}
		\begin{tikzpicture}[quantoan]
			\clip(-0.54,-0.7) rectangle (7.48,5.76);
			...
			\begin{scriptsize}
			\draw[color=black] (1.46,4.9) node {$85$};
			\draw[color=black] (2.56,4.3) node {$217$};
			\draw[color=black] (2.2,3.4) node {$186$};
			\draw[color=black] (3.1,3.05) node {$103$};
			\draw[color=black] (4.68,2.7) node {$183$};
			\draw[color=black] (3.74,1.39) node {$167$};
			\draw[color=black] (5.7,1.65) node {$502$};
			\draw[color=black] (4.96,4.4) node {$173$};
			\draw[color=black] (0.,3.49) node {$80$};
			\draw[color=black] (0.55,1.69) node {$250$};
			\draw[color=black] (2.58,0.3) node {$84$};
			\end{scriptsize}
		\end{tikzpicture}
		\vspace*{-10pt}
	\end{figure}
